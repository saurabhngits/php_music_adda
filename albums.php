	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar"  id="mySidenav" class="sidenav">
			<ul class="nav navbar-nav navbar-center">
				...
				<li  id="Albums" class="active"><a href="albums.php">Albums</a></li>
							...
							<div class="panel-body">
								<div class="row">
									<?php
										...
										$sql = "SELECT distinct album, image FROM songs_metadata ";
										...
										if ($result->num_rows > 0) {
											...
											while($row = $result->fetch_assoc()) {
												echo '
												<div class="col-md-3">
													<div class="thumbnail" onclick="open_player(\'album\',\''.$row['album'].'\');">
														<a href="javascript:void(0);">
															<img src="database/thumbnails/'.$row['image'].'" alt="Lights" style="width:100%">
															<div class="caption">
															  <p>'.$row['album'].'</p>
															</div>
														</a>
