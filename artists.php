	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar"  id="mySidenav" class="sidenav">
			<ul class="nav navbar-nav navbar-center">
				...
				<li  id="Artists"  class="active"><a href="artists.php">Artists</a></li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default">
							<!-- <div class="panel-heading"><strong>New Releases</strong></div> -->
							<div class="panel-body">
								<div class="row">
									<?php
										...
										$sql = "SELECT distinct artist, image, artist_image FROM songs_metadata ";
										...
										if ($result->num_rows > 0) {
											...
											while($row = $result->fetch_assoc()) {
												echo '
												<div class="col-md-3">
													<div class="thumbnail" onclick="open_player(\'artist\',\''.$row['artist'].'\');">
														<a href="javascript:void(0);">
															<img src="database/thumbnails/'.$row['artist_image'].'" alt="Lights" style="width:100%">
															<div class="caption">
															  <p>'.$row['artist'].'</p>
															</div>
														</a>
...
<form action="music_player.php" method="POST" id="open_musicplayer">
...
<script>
	function open_player(category, name){
