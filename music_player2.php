...
<?php
	...
	$sql1 = "SELECT name, image  FROM songs_metadata where name='$name' ";
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="breadcrums">
												<a href="index.html">Home</a> &gt; <a href="album.php">All Songs</a> &gt; <a  href="javascript:void(0);" class="songname">'.$row1['name'].'</a>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-4" >
											<div class="playerthumbnail">
												<img id="songimg" src="database/thumbnails/'.$row1['image'].'" alt="Lights" style="width:100%">
										...
										<div class="col-sm-8">
											<div class="playerbox">
												...
												<span id="songname" class="songname">'.$row1['name'].'</span>
												<div class="player paused">
													...
													<audio id="audioscr" preload src="database/songs/'.$row1['name'].'"></audio>
												</div>
											</div>
										</div>
										<div class="col-sm-8">
											<div class="songslist">
												<table class="table">
			';
												$sql1_1 = "SELECT * FROM songs_metadata ORDER BY name ASC";
												...
												if ($result1_1->num_rows > 0) {
													...
													while($row1_1 = $result1_1->fetch_assoc()) {
														echo '
															<tr onclick="changesong(\''.$count.'\'); changeimg(\''.$row1_1['image'].'\');"   class="activesong">
																<th width="5%">'.$count.'</th>
																<td>
																	<strong>'.$row1_1['name'].'</strong><br/>'.$row1_1['album'].' > '.$row1_1['artist'].'
																</td>
	...
	$sql3 = "SELECT * FROM songs_metadata ORDER BY name ASC";
		...
		echo '
			var pos = 0;
				...
				function playsong(index_value){
					...
					document.getElementsByClassName("songname")[0].innerHTML = songs_queue[index_value];
					document.getElementsByClassName("songname")[1].innerHTML = songs_queue[index_value];
				...
				function changeimg(img){
					document.getElementById("songimg").src="database/thumbnails/"+img;
				}
